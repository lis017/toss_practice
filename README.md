...
앱 뜨면 로그에 아래가 찍힙니다 (공부용: 한글·영어 이중 로그. 제출 전에는 영어 줄만 남기면 됨):
```
[초기화] 캐시백 예산 생성 - 총 예산: 100000000원
[init] cashback budget created - totalBudget=100000000 KRW
[테스트] POST http://localhost:8080/api/v1/payments
[hint] POST http://localhost:8080/api/v1/payments
```
...
[TX2] compensation done - txId=..., amount=... KRW restored
```
...
[circuit-breaker] OPEN - short-circuit, accountId=...
```
